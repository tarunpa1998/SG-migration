...
const CategorySection = ({ countries = [] }: CategorySectionProps) => {
  // Base categories that are always shown
  const categories = [
    {
      title: "Scholarships",
    ...
    {
      title: "Countries",
      description: `Explore ${countries.length} study destinations worldwide`,
      icon: Globe,
      href: "/countries"
    },
    {
